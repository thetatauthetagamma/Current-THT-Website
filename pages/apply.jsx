...
export default function Application() {
  ...
  useEffect(() => {
    ...
    // Example: If you have a "Semesters" or "Application_Settings" table:
    ...
    //     setIsPastDue(dayjs().isAfter(dayjs(data.due_date)))
    //   }
    // }
    // fetchSettings()
  ...
  const handleCrop = async () => {
    ...
    // 2) (Optional) compress
    const options = { maxSizeMB: 0.03, maxWidthOrHeight: 1000, useWebWorker: true }
  ...
  return (
    <div className="container mx-auto p-4 max-w-4xl">
      ...
      <div>Hello! Welcome to the Theta Tau rush application! Please be sure to fill out and submit all of the following sections before the due date. There is a section for general info about yourself, a place to upload a profile picture, and some application questions. Your application will only be considered if ALL of the sections are filled in before the due date. </div>
      ...
      {isPastDue && (
        <p className="text-red-600 mb-4">
          Application deadline has passed. You can no longer update your answers.
        </p>
      )}
